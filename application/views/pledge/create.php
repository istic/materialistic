	...
	<div class="col-sm-9 col-md-6">
		...
		<form role="form" method="POST" action='/pledges/create'>
			...
			<div class="form-group <?PHP echo form_error('backing_tier') ? 'has-error' : '' ?>">
				...
				<input type="text" id="backing_tier" name="backing_tier" class="form-control" value="<?php echo set_value('backing_tier'); ?>">
			</div>
				...
				<div class="radio">
				  <label>
				    <input type="radio" name="is_delivered" id="is_delivered1" value="Yes"
				     <?php echo set_value('is_delivered') == 'Yes' ? 'checked' : '' ?>>
				 ...
				 <div class="radio">
				  <label>
				    <input type="radio" name="is_delivered" id="is_delivered3" value="Partially"
				     <?php echo set_value('is_delivered') == 'Partially' ? 'checked' : '' ?>>
				 ...
				 <div class="radio">
				  <label>
				    <input type="radio" name="is_delivered" id="is_delivered3" value="No"
				     <?php echo set_value('is_delivered') == 'No' ? 'checked' : '' ?>>
			...
			<div class="form-group <?PHP echo form_error('date_promised') ? 'has-error' : '' ?>">
				...
				<input type="text" id="date_promised" name="date_promised" class="form-control datepicker" value="<?php echo set_value('date_promised'); ?>">
			...
			<div class="form-group <?PHP echo form_error('date_reasonable') ? 'has-error' : '' ?>">
				...
				<input type="text" id="date_reasonable" name="date_reasonable" class="form-control datepicker" value="<?php echo set_value('date_reasonable'); ?>">
			...
			<div class="form-group <?PHP echo form_error('date_delivered') ? 'has-error' : '' ?>">
				...
				<input type="text" id="date_delivered" name="date_delivered" class="form-control datepicker" value="<?php echo set_value('date_delivered'); ?>">
